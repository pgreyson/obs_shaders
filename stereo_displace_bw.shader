// stereo_displace_bw : stereo_displace with wide 3-tap depth blur (4px
// spacing, ~8px kernel) for more aggressive smoothing of depth edges.
// obs-shaderfilter port of structure_tools/glsl/fx/0_stereo_displace_bw.glsl
//
// Same as stereo_displace_b but with wider tap spacing — use for patches
// with strong depth edges where the narrow blur isn't enough.
